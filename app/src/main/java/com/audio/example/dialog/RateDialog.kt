...
import com.audio.example.databinding.DialogRateBinding

class RateDialog(context: Activity) : BaseDialog<DialogRateBinding>(context, Gravity.CENTER, false, false) {
